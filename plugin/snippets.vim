...
if !hasmapto('<Plug>SnippetsAddSnippet', 'n')
	nmap <silent> <unique> <leader>jsa <Plug>SnippetsAddSnippet
endif

if !hasmapto('<Plug>SnippetsAddSnippet', 'v')
	vmap <silent> <unique> <leader>jsa <Plug>SnippetsAddSnippet
endif

if !hasmapto('<Plug>SnippetsAppendSnippet', 'n')
	nmap <silent> <unique> <leader>jsp <Plug>SnippetsAppendSnippet
endif

if !hasmapto('<Plug>SnippetsInsertSnippet', 'n')
	nmap <silent> <unique> <leader>jsP <Plug>SnippetsInsertSnippet
endif

if !hasmapto('<Plug>SnippetsEditSnippet', 'n')
	nmap <silent> <unique> <leader>jse <Plug>SnippetsEditSnippet
endif

if !hasmapto('<Plug>SnippetsDeleteSnippet', 'n')
	nmap <silent> <unique> <leader>jsd <Plug>SnippetsDeleteSnippet
endif

if !hasmapto('<Plug>SnippetsListSnippets', 'n')
	nmap <silent> <unique> <leader>jsl <Plug>SnippetsListSnippets
endif
